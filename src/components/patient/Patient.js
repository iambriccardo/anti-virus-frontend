...
export default function Patient() {
    ...
    const chartData = data.symptomsOfPatient.map((symptom) => ({
                ...
                <div>
                    <Grid container spacing={3}>
                        ...
                        <Grid item container xs={6} spacing={2}>
                            ...
                            <Grid item xs={12}>
                                   <Typography align="center"> The live chat will be deployed in a future release! Please, stay tuned!</Typography>
                            </Grid>
                        </Grid>
                    </Grid>
                </div>
